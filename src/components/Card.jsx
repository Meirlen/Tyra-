...
const Card = ({ title, count, update, navigateTo }) => {
  const handleClick = () => {
    navigateTo();
  };
        ...
        <div className='sub-heading'>
          <span>
            <svg width="21" height="17" viewBox="0 0 21 17" fill="none" xmlns="http://www.w3.org/2000/svg">
              <rect x="20.2776" y="17.0002" width="20.2791" height="16.1308" rx="8.0654" transform="rotate(-180 20.2776 17.0002)" fill="#2ED6A3" fillOpacity="0.15" />
              <g clipPath="url(#clip0_638_746)">
